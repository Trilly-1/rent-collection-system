    ...
    >
      <div className="rounded-3xl border border-line-200 bg-white p-6 shadow-2xl sm:p-8">
        ...
        <div className="mt-6 flex items-center justify-between text-sm">
          <Link to="/forgot-password?role=tenant" className="font-semibold text-ink-600 hover:text-ink-900 transition-colors cursor-pointer">
            Forgot password?
          </Link>
          <Link to="/tenant-register" className="font-semibold text-primary-600 hover:text-primary-700 transition-colors cursor-pointer flex items-center gap-1">
            Create Account
